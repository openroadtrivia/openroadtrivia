...
export const EXCURSIONS: Record<number, Excursion[]> = {
  1: [
    { name: "Dwight — Ambler's Texaco", dist: "60 mi south", desc: "One of the best-preserved 1930s gas stations on all of Route 66.", question: { q: "Ambler's Texaco Gas Station in Dwight, Illinois was designed to look like what to make motorists comfortable?", a: ["A house — the domestic cottage style", "A castle with turrets", "A log cabin", "A church with a steeple"], correct: 0, bonus: "The domestic-style gas station was designed to look residential so early motorists would feel safe stopping. Ambler's is now a Route 66 visitor center, restored with Illinois SHPO funding. The peaked roof, shuttered windows, and flower boxes were meant to make roadside commerce feel trustworthy in an era when filling stations were still a new concept.", synopsis: "Ambler's Texaco represents a specific era when oil companies designed stations to blend into neighborhoods. The cottage style reassured drivers that stopping was safe. Listed on the National Register of Historic Places." } },
    { name: "Odell — Standard Oil Station", dist: "75 mi south", desc: "A 1932 station restored to its original white clapboard perfection.", question: { q: "The Standard Oil Station in Odell, Illinois was built in 1932. What architectural feature makes it significant?", a: ["Its original canopy extending over the pump island", "A two-story observation tower", "Underground storage visible through glass", "A rotating neon sign"], correct: 0, bonus: "The canopy was revolutionary — it protected customers from weather while creating a visual landmark visible from the road. The Illinois SHPO led the restoration. Today it's one of the most photographed small buildings on Route 66, a perfect capsule of 1930s roadside architecture.", synopsis: "Gas station architecture evolved rapidly in the 1930s as oil companies competed for motorists. The Odell station's canopy solved a practical problem while also catching the eye of passing drivers." } },
  ],
  2: [
    { name: "Pontiac — Route 66 Hall of Fame", dist: "65 mi north", desc: "The Mother Road's museum in a town that celebrates every mile of it.", question: { q: "Pontiac, Illinois is home to the Route 66 Hall of Fame and Museum. The town also features a giant outdoor mural of what?", a: ["The Route 66 shield — one of the largest on the highway", "A map of all 2,448 miles", "A portrait of John Steinbeck", "A mural of every state flag on the route"], correct: 0, bonus: "Pontiac's giant Route 66 shield mural is one of the most popular photo spots on the entire highway. The town has embraced its Route 66 identity with multiple murals, a museum, and a dedicated preservation effort that draws thousands of road-trippers annually.", synopsis: "Pontiac turned its Route 66 heritage into an economic engine. The Hall of Fame museum preserves memorabilia and stories from every era of the highway's history." } },
    { name: "Litchfield — Ariston Café", dist: "55 mi south", desc: "Serving travelers since 1924 — two years before Route 66 even existed.", question: { q: "The Ariston Café in Litchfield, Illinois is one of the oldest restaurants on Route 66. When did it open?", a: ["1924 — two years before Route 66 was designated", "1930", "1926 — the same year as Route 66", "1940"], correct: 0, bonus: "The Ariston predates Route 66 itself. Listed on the National Register of Historic Places, it has survived the Great Depression, World War II, the Interstate era, and the decline of Route 66. Four generations of the Adam family have kept it running. The café proves that quality food outlasts any economic shift.", synopsis: "The Ariston Café opened on the road that would become Route 66 before anyone knew what that road would become. Its survival through every era of American road travel makes it a living timeline." } },
  ],
  3: [
  ...
  4: [
    { name: "Cuba — Wagon Wheel Motel", dist: "25 mi east", desc: "Stone cabins, a drive-in theater, and the heart of Ozark Route 66.", question: { q: "Cuba, Missouri is home to the Wagon Wheel Motel, a classic motor court with individual cabins built from what material?", a: ["Locally quarried Ozark stone", "Adobe brick", "Railroad ties", "Concrete block"], correct: 0, bonus: "Cuba's stretch of Route 66 also includes the 66 Drive-In Theatre, one of the last surviving drive-in movie theaters on the highway. The Wagon Wheel's stone cabins represent Ozark craftsmanship — builders used materials from the land around them. Both are listed on the National Register.", synopsis: "Cuba's motor courts and drive-in theater represent the golden age of Route 66 roadside culture in the Missouri Ozarks. The stone construction is distinctly Ozarkian — a regional building tradition." } },
  ],
  6: [
  ...
  8: [
    ...
    { name: "Shamrock — U-Drop Inn", dist: "100 mi east", desc: "Art Deco masterpiece gas station. A Texas State Antiquities Landmark.", question: { q: "The Tower Station and U-Drop Inn in Shamrock, Texas is a masterpiece of what architectural style?", a: ["Art Deco", "Spanish Colonial Revival", "Streamline Moderne", "Prairie School"], correct: 0, bonus: "Designed by local architect J.C. Berry in 1936, the U-Drop Inn's green-tiled tower and ornamental spire are visible from a mile away. It's both a National Register listing and a Texas State Antiquities Landmark — one of the highest preservation designations in the state. Fully restored in 2003, it now serves as a visitor center.", synopsis: "The U-Drop Inn proves that even a gas station in a small Texas town could aspire to architectural greatness. Art Deco was the style of the modern age, and applying it to a filling station was a bold statement." } },
  ],
  10: [
  ...
  13: [
    { name: "Holbrook — Wigwam Village #6", dist: "55 mi east", desc: "Sleep in a concrete teepee. One of the most iconic Route 66 photos.", question: { q: "Wigwam Village #6 in Holbrook, Arizona was built in 1950. How many of the original seven Wigwam Villages survive today?", a: ["Three", "Five", "One", "Seven"], correct: 0, bonus: "Each 'wigwam' is a 28-foot concrete and steel teepee with a single room inside. The village has been continuously operating as a motel since it opened. It's listed on the National Register and is the ultimate example of programmatic architecture — buildings shaped like the thing they sell.", synopsis: "Wigwam Village represents 'mimetic' architecture — buildings designed to catch the eye of passing motorists. A motel shaped like teepees. This tradition thrived on Route 66 where roadside visibility was the entire business model." } },
  ],
  14: [
  ...
  15: [
    ...
    { name: "Seligman — Snow Cap Drive-In", dist: "75 mi east", desc: "Where a barber saved Route 66. Home of the Guardian of the Mother Road.", question: { q: "Angel Delgadillo, the barber of Seligman, Arizona, is known by what title for his role in saving Route 66?", a: ["The Guardian of the Mother Road", "The Father of Route 66", "The Last Man Standing", "The Neon Saint"], correct: 0, bonus: "When I-40 bypassed Seligman in 1978, the town nearly died. Angel Delgadillo organized local business owners to petition for Historic Route 66 designation, which passed in 1987. His campaign sparked the Route 66 revival movement that spread across all eight states. The Snow Cap Drive-In, run by his brother Juan, is famous for fake mustard bottles and deadpan humor.", synopsis: "Seligman is the town that saved Route 66. Without Angel Delgadillo's campaign, the preservation movement might never have started. His barbershop is now a pilgrimage site for Route 66 travelers." } },
  ],
  18: [
    ...
    { name: "San Bernardino — Original McDonald's", dist: "70 mi west", desc: "The exact spot where two brothers changed how America eats.", question: { q: "The McDonald brothers opened their original restaurant in San Bernardino in 1940. What revolutionary system did they invent there?", a: ["The Speedee Service System — assembly-line food preparation", "The drive-through window", "The Happy Meal concept", "The franchise licensing model"], correct: 0, bonus: "Richard and Maurice McDonald stripped their menu down to burgers, fries, and shakes, then redesigned the kitchen like a factory assembly line. The result cut service time from 30 minutes to 30 seconds. Ray Kroc saw the system, bought the franchise rights, and built an empire. The original site is now a museum — not a McDonald's restaurant.", synopsis: "The Speedee Service System was the birth of fast food. The McDonald brothers' innovation wasn't the food — it was the process. San Bernardino is also home to Wigwam Village #7, the California twin of Holbrook's teepee motel." } },
  ],
  19: [
